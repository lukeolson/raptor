...
int main (int argc, char *argv[]) 
{
	...
	if (myRank == root) {
		MPI_Win_allocate_shared((MPI_Aint) size_colptr*sizeof(int),sizeof(int),MPI_INFO_NULL,sm_comm,&U_colptr_shared,&sm_winT0);
        MPI_Win_allocate_shared((MPI_Aint) size_indices*sizeof(int),sizeof(int),MPI_INFO_NULL,sm_comm,&U_indices_shared,     &sm_winT1);
		MPI_Win_allocate_shared((MPI_Aint) size_aij*sizeof(double),sizeof(double),MPI_INFO_NULL,sm_comm,&aij_U_shared,&sm_winT2);
        MPI_Win_allocate_shared((MPI_Aint) size_data*sizeof(double),sizeof(double),MPI_INFO_NULL,sm_comm,&U_data_shared,     &sm_winT3);
		MPI_Win_allocate_shared((MPI_Aint) size_data*sizeof(double),sizeof(double),MPI_INFO_NULL,sm_comm,&U_backup_shared,&sm_winT4);
           } else {
			MPI_Win_allocate_shared((MPI_Aint) 0,sizeof(int),MPI_INFO_NULL,sm_comm,&U_colptr_shared,&sm_winT0);
        MPI_Win_allocate_shared((MPI_Aint) 0,sizeof(int),MPI_INFO_NULL,sm_comm,&U_indices_shared,     &sm_winT1);
		MPI_Win_allocate_shared((MPI_Aint) 0,sizeof(double),MPI_INFO_NULL,sm_comm,&aij_U_shared,&sm_winT2);
        MPI_Win_allocate_shared((MPI_Aint) 0,sizeof(int),MPI_INFO_NULL,sm_comm,&U_data_shared,     &sm_winT3);
		MPI_Win_allocate_shared((MPI_Aint) 0,sizeof(double),MPI_INFO_NULL,sm_comm,&U_backup_shared,&sm_winT4);
           } // end if //
