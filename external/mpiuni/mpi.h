...
/*
    Modified July 15, 2015 by Raptor development team at UIUC
    Some modifications were made to get the library to compile without PETSc

    Instructions for building standalone MPIUNI [for eg: linux/gcc+gfortran]:
    - extract include/mpiuni/mpi.h, mpif.h, src/sys/mpiuni/mpi.c from PETSc
    - remove reference to petscconf.h from mpi.h and mpi.c
    - Add dummy definitions for PETSC_EXTERN and PETSC_STDCALL to mpi.h
    - Add include statements for stdlib.h and mpi.h in mpi.c
    - Add dummy definition of function MPI_Wtime() in mpi.c
    - gcc -c mpi.c -I. -DPETSC_HAVE_FORTRAN_UNDERSCORE
    - ar cr libmpiuni.a mpi.o

    Also, to remove warnings, some definitions of the form
